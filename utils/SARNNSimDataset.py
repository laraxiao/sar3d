...
class SARimgelevazimDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # print(pd.read_csv(realimgpath, header=None))
        ...
        # crate tensor of [1,124,124](124 is image size, with all elements being 1)
        ...
        return sample
#sample returns: filename, a tensor of size[1, imagsize,imagsize],elev,azim
